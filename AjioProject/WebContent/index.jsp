...
<script>
 ...
 function submitForm(f){
	...
	<div id="carouselExampleIndicators" class="carousel slide"
		...
		<div class="carousel-inner">
			<div class="carousel-item active">
				<img class="d-block w-100" src="img/slider/4.webp" alt="First slide">
			</div>
			<div class="carousel-item">
				<img class="d-block w-100" src="img/slider/3.webp"
					alt="Second slide">
			</div>
			<div class="carousel-item">
				<img class="d-block w-100" src="img/slider/6.webp" alt="Third slide">
			</div>
		</div>
	...
	<section id="products_list">
		<div class="container shopping_items mt-5">
			<div class="row">
				<div class="col-md-3">
					<!-- left -->
					<div class="list-group">
						<!-- products -->
						<a href="user?action=all-products#products_list"
							class="list-group-item" onclick="makeInVisible()">
							AllProducts </a> <a href="user?action=Formal_Shoes#products_list"
							class="list-group-item" onclick="makeInVisible()">Formal_Shoes</a>
						<a href="user?action=Casual_Shoes#products_list"
							class="list-group-item" onclick="makeInVisible()">Casual_Shoes</a>
						<a href="user?action=Sport_Shoes#products_list"
							class="list-group-item" onclick="makeInVisible()">Sport_Shoes</a>
						<a href="user?action=Watches#products_list"
							class="list-group-item" onclick="makeInVisible()">Watches</a> <a
							href="user?action=Sun_Glasses#products_list"
							class="list-group-item" onclick="makeInVisible()">Sun_Glasses</a>
					</div>
				</div>
				<!-- left -->
				<div class="col-md-9 items_list">
					<!-- right -->
